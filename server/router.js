...
const router = (app) => {
  ...
  app.get('/getName', controllers.getNameD)
  app.get('/findByName', controllers.searchName);
  app.get('/findByNameD', controllers.dogSearchName);
  ...
  app.post('/setNameD', controllers.dogSetName);

  // When someone POSTS to /updateLast, call controllers.updateLast
  app.post('/updateLast', controllers.updateLast);
  app.post('/updateLastD', controllers.dogUpdateLast);
};
